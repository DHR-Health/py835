...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      <th>0</th>
      <td>uyp9he-3zu6Uf-43phhe-UvjtRK</td>
      <td>X1gC3t-Bo3TkJ-aVHBoX-orMSsM</td>
      <td>4Evs8Y-nrmUAa-tjvgPg-EMmA1P</td>
      <td>ST01-835</td>
...
The image below shows the relationships between the tables accessible via `parser.pandas`.
...
You can access individual components of the 835 file using the class tree, if you so desire:
...
1. **Functional Groups (GS):**  `parser.pandas.FUNCTIONAL_GROUPS`
...
1. **Statements (ST):**  `parser.pandas.STATEMENTS`
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      ...
      <td>X1gC3t-Bo3TkJ-aVHBoX-orMSsM</td>
      <td>4Evs8Y-nrmUAa-tjvgPg-EMmA1P</td>
      <td>MN5w5F-HIce1e-VyWC7t-L8cr1H</td>
      <td>CLP01</td>
...
1. **Service Line Items (SVC):**  `parser.pandas.SERVICES`
...
parser.pandas.SERVICES_CAS.head(3)
```
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      ...
      <td>4Evs8Y-nrmUAa-tjvgPg-EMmA1P</td>
      <td>MN5w5F-HIce1e-VyWC7t-L8cr1H</td>
      <td>fvPWJ9-HLCWja-1vFWiq-oVAPMd</td>
      <td>CAS01-CO</td>
...
<table border="1" class="dataframe">
  ...
  <tbody>
    <tr>
      <th>0</th>
      <td>0</td>
      <td>f8mWF0-tIIad8-PGgsRF-kNFJqq</td>
      <td>1</td>
      <td>191511902</td>
      <td>00</td>
      <td></td>
