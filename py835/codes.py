...
def connect():
    ...
    try:
        ...
        with importlib.resources.path('py835.codes_dir', 'codes.db') as db_path:
...
def update_claim_adjustment_reason_codes():
    conn = connect()
    with importlib.resources.path('py835.codes_dir', 'claim_adjustment_reason_codes.csv') as file_path:
...
def update_claim_status_category_codes():
    conn = connect()
    with importlib.resources.path('py835.codes_dir', 'claim_status_category_codes.csv') as file_path:
...
def update_claim_status_codes():
    conn = connect()
    with importlib.resources.path('py835.codes_dir', 'claim_status_codes.csv') as file_path:
...
def update_provider_adjustment_reason_codes():
    conn = connect()
    with importlib.resources.path('py835.codes_dir', 'provider_adjustment_reason_codes.csv') as file_path:
